	...
	<div class="container ">
		...
		<div class="collapse navbar-collapse " id="navbarNav">
			<ul class="navbar-nav w-100 font-cu-cairo"  >
				...
				<div class="container">
					<h1>Add Vedio</h1>
					<form:form action="process-Addvedio" method="post" modelAttribute="vediodto">
						عنوان الفيديو
						<br>
						...
						<br>
						<form:input type="hidden" path="type" value="vedio"/>
					 	<input type="submit" value="Add Vedio">
