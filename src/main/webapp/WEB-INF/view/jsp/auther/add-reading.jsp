...
<h1>Add Reading</h1>
<form:form action="process-addreading" method="post" modelAttribute="readingdto">
	العنوان<form:input type="text" path="title"/>	<br><br>
	النص<form:textarea path="text" rows="10" cols="100"/>	<br><br>
	الوصف<form:textarea path="desctiption" rows="3" cols="100"/>	<br><br>
