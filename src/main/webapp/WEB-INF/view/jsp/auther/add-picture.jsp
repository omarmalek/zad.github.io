...
<style> .col-* {border:1px solid red;}</style>
...
<h1 >أضف صورة</h1>
<form:form  class="row g-3 " action="process-addpicture" method="post" enctype="multipart/form-data" modelAttribute="pictureDTO">
  
  <div class="col-12 mb-3">
    <label for="inputAddress" class="form-label " >عنوان الصورة</label>
    <form:input type="text" path="title" class="form-control" id="title" placeholder="عنوان الصورة"/>
  </div>

  <div class="col-12 mb-3">
  <label for="formFile" class="form-label" >حدد ملف الصورة</label>
   <form:input  class="form-control" type="file" path="image" id="formFile"/>
</div>
  <div class="col-12 mb-3">
    <label for="inputAddress2" class="form-label" >الوصف</label>
    <form:input class="form-control" type="text" path="description"  id="Description" placeholder="الوصف"/>
  </div>
  
  <div class="col-12">
    <button type="submit" class="btn btn-primary "> أضف صورة</button>
  </div>
</form:form>
